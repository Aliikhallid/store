...
import GroundFloor from '../../assets/apartment-groundfloor.webp'
import FirstFloor from '../../assets/apartment-firstfloor.webp'
import { useLayoutEffect } from "react";
import ImageSlider from "../ImageSlider";

const MadinatyApartments = () => {
...
const loadImages = (project: string,lastImage:number) => {
  ...
  <div className={`p-4 relative ${isRTL? "border-l":"border-r"} border-white flex flex-col gap-1 justify-center`}><p className="md:text-[16px] text-[14px] text-primary">Category</p> <p className="md:text-[14px] text-[10px]">Residential Apartment</p> </div>
  <div className={`p-4 relative ${isRTL? "border-l":"border-r"} border-white flex flex-col gap-1 justify-center`}><p className="md:text-[16px] text-[14px] text-primary">Buildings</p> <p className="md:text-[14px] text-[10px]">21</p> </div>
  <div className="p-4 relative  flex flex-col gap-1 justify-center"><p className="md:text-[16px] text-[14px] text-primary">Floors</p> <p className="md:text-[14px] text-[10px]">Ground floor, 3 floors</p> </div>
  <div className={`p-4 relative ${isRTL? "border-l":"border-r"} border-white flex flex-col gap-1 justify-center`}><p className="md:text-[16px] text-[14px] text-primary">Units per floor</p> <p className="md:text-[14px] text-[10px]">4</p> </div>
  <div className={`p-4 relative ${isRTL? "border-l":"border-r"} border-white flex flex-col gap-1 justify-center`}><p className="md:text-[16px] text-[14px] text-primary">Units per building</p> <p className="md:text-[14px] text-[10px]">16</p> </div>
  <div className="p-4 relative  flex flex-col gap-1 justify-center"><p className="md:text-[16px] text-[14px] text-primary">Total Units</p> <p className="md:text-[14px] text-[10px]">336</p> </div>
    ...
    <div className="flex flex-col h-fit w-full py-5 justify-center items-center text-center">
      ...
      <ImageSlider imgUrls={loadImages("MadinatyApartments",0)} imgOverText={["Outdoor"]} />
    ...
    <h1 className='regular text-md relative mt-40'>DEMONSTRATION ~ Madinaty Apartments</h1>
    ...
    <div className="flex flex-col h-fit w-fit">
      <div className="flex justify-center items-center regular text-xl text-primary-color mt-10">Madinaty Apartments</div>
...
export default MadinatyApartments;
