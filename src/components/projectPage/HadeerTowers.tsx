  ...
  return (
    <div className="project-page flex flex-col h-fit t-10 bg-white" dir={`${isRTL? "rtl":"ltr"}`}>
      ...
      <div
        ...
        <p className="md:text-[64px] text-[12px]">Al Hadeer Towers</p>
        </div>
        <p className="md:max-w-[75rem] text-[22px]  light text-md max-w-[40rem]">The eight Al Hadeer towers are innovatively distributed along the first phase of the Buruj project to ensure privacy and a wonderful view of the bright green spaces and gardens inside and outside the project in all units.</p>
