...
import GroundFloor from '../../assets/lotus-groundfloor.webp'
import FirstFloor from '../../assets/lotus-firstfloor.webp'
import { useLayoutEffect } from "react";
...
const [title, setTitle] = useState('Ground Floor (33.20)M2')
...
const loadImages = (project: string,lastImage:number) => {
  ...
  return (
    <div className="project-page flex flex-col h-fit t-10 bg-white" dir={`${isRTL? "rtl":"ltr"}`}>
      ...
      <div
        ...
        <p className="md:text-[64px] text-[12px]">Lotus</p>
        </div>
        <p className="md:max-w-[75rem] text-[22px]  light text-md max-w-[40rem]">Lotus Villa is the economical choice. It is a classic Villa with 2 bedrooms and a comfortable living room, a parking space for one car, a green yard and a beautiful balcony on the first floor.</p>
  ...
  <div className={`p-4 relative ${isRTL? "border-l":"border-r"} border-white flex flex-col gap-1 justify-center`}><p className="md:text-[16px] text-[14px] text-primary">Number of villas</p> <p className="md:text-[14px] text-[10px]">242 Lotus + 64 Lotus corner</p> </div>
  ...
  <div className={`p-4 relative ${isRTL? "border-l":"border-r"} border-white flex flex-col gap-1 justify-center`}><p className="md:text-[16px] text-[14px] text-primary">Ground floor</p> <p className="md:text-[14px] text-[10px]">106 m2</p> </div>
  <div className={`p-4 relative ${isRTL? "border-l":"border-r"} border-white flex flex-col gap-1 justify-center`}><p className="md:text-[16px] text-[14px] text-primary">First floor</p> <p className="md:text-[14px] text-[10px]">11.8 m2</p> </div>
  <div className="p-4 relative  flex flex-col gap-1 justify-center"><p className="md:text-[16px] text-[14px] text-primary">Building Area</p> <p className="md:text-[14px] text-[10px]">117.8 m2</p> </div>
    ...
    <div className="flex flex-col h-fit w-full py-5 justify-center items-center text-center">
      ...
      <ImageSlider imgUrls={loadImages("Lotus",2)} imgOverText={["Streets","Living Room","Football Turf"]} />
    ...
    <h1 className='regular text-md relative mt-40'>DEMONSTRATION ~ LOTUS</h1>
    ...
    <div className="flex flex-col h-fit w-fit">
      <div className="flex justify-center items-center regular text-xl text-primary-color mt-10">Lotus</div>
