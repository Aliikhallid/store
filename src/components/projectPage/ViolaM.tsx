  ...
  return (
    <div className="project-page flex flex-col h-fit t-10 bg-white" dir={`${isRTL? "rtl":"ltr"}`}>
      ...
      <div
        ...
        <p className="md:max-w-[75rem] text-[22px]  light text-md max-w-[40rem]">The most popular Villas in the project, with modern pattern, which were especially designed for families who are looking for a comfortable housing, characterized by an elegant design, with parking spaces for two cars, green yard and large balcony.</p>
