...
import GroundFloor from '../../assets/jory-groundfloor.webp'
import FirstFloor from '../../assets/jury-firstfloor.webp'
import { useLayoutEffect } from "react";
...
const [title, setTitle] = useState('Ground Floor (198.40)M2')
const [overviewP2, setOverview2] = useState('Rooms')
const [t1, setT1] = useState('Reception');
const [t2, setT2] = useState('Living Room');
const [t3, setT3] = useState('Bathroom');
const [t4, setT4] = useState('Kitchen');
const [t5, setT5] = useState('Store');
const [t6, setT6] = useState('Master Bedroom');
const [t7, setT7] = useState('Master Bathroom');
const [t8, setT8] = useState('Bedroom');
const [t9, setT9] = useState('WC');
const [d1, setD1] = useState('6.0 M x 4.0 M');
const [d2, setD2] = useState('6.2 M x 4.0 M');
const [d3, setD3] = useState('2.5 M x 1.8 M');
const [d4, setD4] = useState('5.2 M x 4.0 M');
const [d5, setD5] = useState('2.0 M x 1.0 M');
const [d6, setD6] = useState('4.0 M x 4.4 M');
const [d7, setD7] = useState('2.5 M x 1.6 M');
const [d8, setD8] = useState('4.0 M x 4.0 M');
const [d9, setD9] = useState('1.6 M x 1.4 M');
  ...
  const setOver = () => {
    ...
    setShoww(true)
    setOverview('')
    setTitle('Ground Floor (198.40)M2')
    setOverview2('Rooms')
    setT1('Reception')
 setT2('Living Room');
 setT3('Bathroom');
...
const loadImages = (project: string,lastImage:number) => {
  ...
  return (
    <div className="project-page flex flex-col h-fit t-10 bg-white" dir={`${isRTL? "rtl":"ltr"}`}>
      ...
      <div
        ...
        <p className="md:text-[64px] text-[12px]">Jory</p>
        </div>
        <p className="md:max-w-[75rem]  text-[22px] light text-md max-w-[40rem]">The most luxurious villa in the project, with four bedrooms and a comfortable living room. The villa has two parking spaces and beautiful yard in addition to a large balcony.</p>
  ...
  <div className={`p-4 relative ${isRTL? "border-l":"border-r"} border-white flex flex-col gap-1 justify-center`}><p className="md:text-[16px] text-[14px] text-primary">Number of villas</p> <p className="md:text-[14px] text-[10px]">72 Jory + 38 Jory corner</p> </div>
  ...
  <div className={`p-4 relative ${isRTL? "border-l":"border-r"} border-white flex flex-col gap-1 justify-center`}><p className="md:text-[16px] text-[14px] text-primary">Ground floor</p> <p className="md:text-[14px] text-[10px]">142.60 m2 Jory, 143.00 m2 Jory Corner</p> </div>
  <div className={`p-4 relative ${isRTL? "border-l":"border-r"} border-white flex flex-col gap-1 justify-center`}><p className="md:text-[16px] text-[14px] text-primary">First floor</p> <p className="md:text-[14px] text-[10px]">55.80 m2 Jory, 56.30 m2 Jory Corner</p> </div>
  <div className="p-4 relative  flex flex-col gap-1 justify-center"><p className="md:text-[16px] text-[14px] text-primary">Building Area</p> <p className="md:text-[14px] text-[10px]">198.40 m2 Jory, 199.30 m2 Jory Corner</p> </div>
    ...
    <div className="flex flex-col h-fit w-full py-5 justify-center items-center text-center">
      ...
      <ImageSlider imgUrls={loadImages("Jory",2)} imgOverText={["Living Room","Football Turf","Streets"]} />
    ...
    <h1 className='regular text-md relative mt-40'>DEMONSTRATION ~ JORY</h1>
      ...
      <div className="construct1 flex flex-col justify-center items-center">
        <div className="buruj-btns flex flex-wrap justify-center items-center">
         ...
         <div className="videos h-fit relative flex justify-center items-center">
          ...
          {imgg===1 ? <img src={GroundFloor} height={1000} width={1000}></img> :<img src={FirstFloor} height={1000} width={1000}></img>}</div>
    ...
    <div className="flex flex-col h-fit w-fit">
      <div className="flex justify-center items-center regular text-xl text-primary-color mt-10">Jory</div>
